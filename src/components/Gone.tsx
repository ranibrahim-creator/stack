...
export function Gone() {
  return (
    <div className="relative min-h-dvh overflow-hidden" style={{ background: "var(--bg)" }}>
      ...
      <main className="page-wrap relative z-10 flex min-h-dvh flex-col items-center justify-center py-24 text-center font-[family-name:var(--font-inter-tight)]">
        <motion.p
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 0.6, delay: 0.1 }}
          className="font-[family-name:var(--font-plex-mono)] text-[12px] text-[#5c6166]"
        >
          404
        </motion.p>

        <h1 className="page-title page-title-lg mt-4 max-w-3xl font-normal">
        ...
        <motion.div
          ...
          className="relative mt-8 h-px w-[min(420px,70%)] origin-center"
        >
          <div
